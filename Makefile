...
tests/test_tensor_ops: tests/test_tensor_ops.mm src/nn.mm default.metallib
	clang++ -std=c++23 -O3 -ffast-math -Wall -Wextra tests/test_tensor_ops.mm -framework Metal -framework Foundation -framework Accelerate -o tests/test_tensor_ops

tests/test_allocator: tests/test_allocator.mm src/nn.mm default.metallib
	clang++ -std=c++23 -O3 -ffast-math -Wall -Wextra tests/test_allocator.mm -framework Metal -framework Foundation -framework Accelerate -o tests/test_allocator

tests/test_tensor_ctors: tests/test_tensor_ctors.mm src/nn.mm default.metallib
	clang++ -std=c++23 -O3 -ffast-math -Wall -Wextra tests/test_tensor_ctors.mm -framework Metal -framework Foundation -framework Accelerate -o tests/test_tensor_ctors
...
main: src/nn.mm src/main.mm default.metallib
	clang++ -fobjc-arc -std=c++23 -O3 -ffast-math -Wall -Wextra src/main.mm -framework Metal -framework Foundation -framework Accelerate -o main
